defmodule PrimordialWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use PrimordialWeb.ConnCase, async: true`, although
  ...
  setup tags do
    Primordial.DataCase.setup_sandbox(tags)
  ...
  def register_and_log_in_admin(%{conn: conn}) do
    admin = Primordial.AdminsFixtures.admin_fixture()
  ...
  def log_in_admin(conn, admin) do
    token = Primordial.Admins.generate_admin_session_token(admin)
