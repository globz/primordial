defmodule PrimordialWeb.AdminTowerLive do
  ...
  def render(assigns) do
    ...
    <.header class="text-center">
      [ Tower ]
      <:subtitle>Welcome to the Watch Tower</:subtitle>
    </.header>
        ...
        <ul class="space-y-2 font-medium">
          ...
          <li>
            ...
            >
              ...
              <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap ml-2">Test</span>
              <svg
                class="w-3 h-3"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
          ...
          <li>
            ...
            >
              ...
              <span class="flex-1 ms-3 whitespace-nowrap ml-2">Simulation</span>
          ...
          <li>
            ...
            >
              ...
              <span class="flex-1 ms-3 whitespace-nowrap ml-2">Stuff</span>
            </a>
          </li>
          <li>
            <.link
              href={~p"/panopticon/settings"}
              class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
            >
              <svg
                class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
              ...
              <span class="flex-1 ms-3 whitespace-nowrap ml-2">Account settings</span>
            </.link>
          </li>
          <li>
            <.link
              href={~p"/panopticon/log_out"}
              class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
            >
              <svg
                class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
              ...
              <span class="flex-1 ms-3 whitespace-nowrap ml-2">Sign out</span>
            </.link>
          </li>
        </ul>
      </div>
