defmodule PrimordialWeb.LiveHelpers do
  ...
  def soup_app_drawer(assigns) do
    ...
    # <div id="modal" class="phx-modal fade-in">
    #  <div id="modal-content" class="bg-white p-5 border-2 border-indigo-600
    #   mx-[4px] fade-in-scale grid grid-rows-3 grid-flow-row gap-y-2.5 w-[70%] h-[97%] lg:h-full lg:w-[35%] rounded-4xl">
